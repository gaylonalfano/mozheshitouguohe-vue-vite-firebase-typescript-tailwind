      ...
      >
        ...
        <div class="flex lg:hidden">
          ...
          <button
            ...
            type="button"
            class="inline-flex items-center justify-center p-2 text-gray-400 rounded-md hover:text-white hover:bg-gray-700 transition ease-out duration-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
        ...
        <div class="hidden lg:block lg:ml-4">
          <div class="flex items-center">
            <button
              class="flex-shrink-0 p-1 text-gray-400 bg-gray-800 rounded-full hover:text-white transition ease-out duration-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
            >
    ...
    >
      ...
      <div class="pt-4 pb-3 border-t border-gray-700">
        <div class="flex items-center px-5">
          ...
          <button
            class="flex-shrink-0 p-1 ml-auto text-gray-400 bg-gray-800 rounded-full hover:text-white transition ease-out duration-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
          >
            <span class="sr-only">View notifications</span>
            <!-- Heroicon name: outline/bell -->
            <svg
        ...
        <div class="px-2 mt-3 space-y-1">
          ...
          <span
            @click="handleLogout"
            class="block px-3 py-2 text-base font-medium text-gray-300 rounded-md cursor-pointer hover:text-white hover:bg-gray-700 transition ease-out duration-500"
          >
            Sign out
          </span>
        </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const inactiveClass = ref<string>(
      "text-gray-300 hover:bg-gray-700 hover:text-white transition ease-out duration-500"
    );
